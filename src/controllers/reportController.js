...
const exportEstudantesPDF = async (req, res) => {
    try {
        ...
        // Título do PDF
        doc.fontSize(24).font("Helvetica-Bold").text("Relatório de estudantes e  projetos participantes", { align: "center" });
        doc.moveDown(1);

        // Subtítulo
        doc.fontSize(16).font("Helvetica").text("Lista de Estudantes cadastrados no sistema", { align: "center" });
        doc.moveDown(1);
